...
def save_data():
    global trial_no, df, selected_action, values_plotted, test_sample
...
def live_model_eval(input_data):
    import tensorflow as tf
    print("hello")
    print(input_data)
    ...
    data_values = [int(val) for val in data]
