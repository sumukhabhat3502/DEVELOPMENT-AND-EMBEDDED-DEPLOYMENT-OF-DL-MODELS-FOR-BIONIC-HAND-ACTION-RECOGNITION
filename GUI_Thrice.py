...
def animate(i):
    if not data1.empty():
        ax1.set_xlim(0, data1.qsize())
    if not data2.empty():
        ax2.set_xlim(0, data2.qsize())
    if not data3.empty():
        ax3.set_xlim(0, data3.qsize())

    line1.set_data(range(data1.qsize()), list(data1.queue))
    line2.set_data(range(data2.qsize()), list(data2.queue))
    line3.set_data(range(data3.qsize()), list(data3.queue))
